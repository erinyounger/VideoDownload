...
class Pron91Spider:
    ...
    def init_dirver(self):
        ...
        if platform.system() == "Windows":
            ...
            chromedriver = ChromeDriverManager(url="https://npm.taobao.org/mirrors/chromedriver/",latest_release_url="https://registry.npmmirror.com/-/binary/chromedriver/LATEST_RELEASE").install()
