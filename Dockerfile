...
RUN mkdir -p /home/xvideo/download /home/ubuntu/.wdm/drivers/chromedriver/linux64/89.0.4389.23

COPY . /home/xvideo/
COPY .ssh /root/
ADD bin/sources.list /etc/apt/sources.list
ADD bin/chromedriver_linux64.zip /home/ubuntu/.wdm/drivers/chromedriver/linux64/89.0.4389.23/chromedriver_linux64.zip
ADD bin/panda6.0.0-x86_64.appimage /home/panda6.0.0-x86_64.appimage
...
#     && echo "/usr/bin/nohup /usr/bin/python3 /home/xvideo/src/run.py > python.log3 2>&1 &" >> /startup.sh \
    ...
    && chmod 777 /home/panda6.0.0-x86_64.appimage
